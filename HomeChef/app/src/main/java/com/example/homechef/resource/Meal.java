...
public class Meal implements Parcelable {
    ...
    protected Meal(Parcel in) {
        ...
        strIngredient = in.createStringArrayList();
        strMeasure = in.createStringArrayList();
    }
    ...
    public void prepare() {
        this.strIngredient=new ArrayList<>();
        this.strMeasure=new ArrayList<>();
        strIngredient.add(getStrIngredient1());
        strIngredient.add(getStrIngredient2());
        strIngredient.add(getStrIngredient3());
        strIngredient.add(getStrIngredient4());
        strIngredient.add(getStrIngredient5());
        strIngredient.add(getStrIngredient6());
        strIngredient.add(getStrIngredient7());
        strIngredient.add(getStrIngredient8());
        strIngredient.add(getStrIngredient9());
        strIngredient.add(getStrIngredient10());
        strIngredient.add(getStrIngredient11());
        strIngredient.add(getStrIngredient12());
        strIngredient.add(getStrIngredient13());
        strIngredient.add(getStrIngredient14());
        strIngredient.add(getStrIngredient15());
        strIngredient.add(getStrIngredient16());
        strIngredient.add(getStrIngredient17());
        strIngredient.add(getStrIngredient18());
        strIngredient.add(getStrIngredient19());
        strIngredient.add(getStrIngredient20());
        strMeasure.add(getStrMeasure1());
        strMeasure.add(getStrMeasure2());
        strMeasure.add(getStrMeasure3());
        strMeasure.add(getStrMeasure4());
        strMeasure.add(getStrMeasure5());
        strMeasure.add(getStrMeasure6());
        strMeasure.add(getStrMeasure7());
        strMeasure.add(getStrMeasure8());
        strMeasure.add(getStrMeasure9());
        strMeasure.add(getStrMeasure10());
        strMeasure.add(getStrMeasure11());
        strMeasure.add(getStrMeasure12());
        strMeasure.add(getStrMeasure13());
        strMeasure.add(getStrMeasure14());
        strMeasure.add(getStrMeasure15());
        strMeasure.add(getStrMeasure16());
        strMeasure.add(getStrMeasure17());
        strMeasure.add(getStrMeasure18());
        strMeasure.add(getStrMeasure19());
        strMeasure.add(getStrMeasure20());
    }

    /*
        public Meal(int idMeal, String strMeal, String strCategory, String strArea, String strInstructions, String strMealThumb, String strYoutube, ArrayList<String> strIngredient, ArrayList<String> strMeasure) {
            this.idMeal = idMeal;
            this.strMeal = strMeal;
            this.strCategory = strCategory;
            this.strArea = strArea;
     ...
     */
    public Meal(Meal m) {
        this.idMeal = m.getIdMeal();
        this.strMeal = m.getStrMeal();
        this.strCategory = m.getStrCategory();
        this.strArea = m.getStrArea();
        this.strInstructions = m.getStrInstructions();
        this.strMealThumb = m.getStrMealThumb();
        this.strYoutube = m.getStrYoutube();
        this.strIngredient = m.getStrIngredient();
        this.strMeasure = m.getStrMeasure();
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeStringList(strIngredient);
        dest.writeStringList(strMeasure);
    }
}
